...
export TOXIC_PARAMS=best_configs/bad_word_logreg.yaml
python main.py train_evaluate_predict_cv_pipeline -p bad_word_logreg -m first

# neptune run \
# --config best_configs/count_logreg.yaml \
# -- train_evaluate_predict_cv_pipeline -p count_logreg -m first
export TOXIC_PARAMS=best_configs/count_logreg.yaml
python main.py train_evaluate_predict_cv_pipeline -p count_logreg -m first

# neptune run \
# --config best_configs/tfidf_logreg.yaml \
# -- train_evaluate_predict_cv_pipeline -p tfidf_logreg -m first
export TOXIC_PARAMS=best_configs/tfidf_logreg.yaml
python main.py train_evaluate_predict_cv_pipeline -p tfidf_logreg -m first

# neptune run \
# --config best_configs/char_vdcnn.yaml \
# -- train_evaluate_predict_cv_pipeline -p char_vdcnn -m first
export TOXIC_PARAMS=best_configs/char_vdcnn.yaml
python main.py train_evaluate_predict_cv_pipeline -p char_vdcnn -m first

# neptune run \
# --config best_configs/fasttext_gru.yaml \
# -- train_evaluate_predict_cv_pipeline -p fasttext_gru -m first
export TOXIC_PARAMS=best_configs/fasttext_gru.yaml
python main.py train_evaluate_predict_cv_pipeline -p fasttext_gru -m first

# neptune run \
# --config best_configs/fasttext_lstm.yaml \
# -- train_evaluate_predict_cv_pipeline -p fasttext_lstm -m first
export TOXIC_PARAMS=best_configs/fasttext_lstm.yaml
python main.py train_evaluate_predict_cv_pipeline -p fasttext_lstm -m first
...
export TOXIC_PARAMS=best_configs/fasttext_scnn.yaml
python main.py train_evaluate_predict_cv_pipeline -p fasttext_scnn -m first

# neptune run \
# --config best_configs/glove_scnn.yaml \
# -- train_evaluate_predict_cv_pipeline -p glove_scnn -m first
export TOXIC_PARAMS=best_configs/glove_scnn.yaml
python main.py train_evaluate_predict_cv_pipeline -p glove_scnn -m first

# neptune run \
# --config best_configs/fasttext_dpcnn.yaml \
# -- train_evaluate_predict_cv_pipeline -p fasttext_dpcnn -m first
export TOXIC_PARAMS=best_configs/fasttext_dpcnn.yaml
python main.py train_evaluate_predict_cv_pipeline -p fasttext_dpcnn -m first

# neptune run \
# --config best_configs/glove_dpcnn.yaml \
# -- train_evaluate_predict_cv_pipeline -p glove_dpcnn -m first
export TOXIC_PARAMS=best_configs/glove_dpcnn.yaml
python main.py train_evaluate_predict_cv_pipeline -p glove_dpcnn -m first

# neptune run \
# --config best_configs/word2vec_gru.yaml \
# -- train_evaluate_predict_cv_pipeline -p word2vec_gru -m first
export TOXIC_PARAMS=best_configs/word2vec_gru.yaml
python main.py train_evaluate_predict_cv_pipeline -p word2vec_gru -m first

# neptune run \
# --config best_configs/word2vec_lstm.yaml \
# -- train_evaluate_predict_cv_pipeline -p word2vec_lstm -m first
export TOXIC_PARAMS=best_configs/word2vec_lstm.yaml
python main.py train_evaluate_predict_cv_pipeline -p word2vec_lstm -m first

# neptune run \
# --config best_configs/word2vec_dpcnn.yaml \
# -- train_evaluate_predict_cv_pipeline -p word2vec_dpcnn -m first
export TOXIC_PARAMS=best_configs/word2vec_dpcnn.yaml
python main.py train_evaluate_predict_cv_pipeline -p word2vec_dpcnn -m first

# neptune run \
# --config best_configs/word2vec_scnn.yaml \
# -- train_evaluate_predict_cv_pipeline -p word2vec_scnn -m first
export TOXIC_PARAMS=best_configs/word2vec_scnn.yaml
python main.py train_evaluate_predict_cv_pipeline -p word2vec_scnn -m first
...
# fasttext_dpcnn \
# fasttext_scnn
export TOXIC_PARAMS=best_configs/setup.yaml
python main.py prepare_single_model_predictions_dir \
count_logreg \
bad_word_logreg \
tfidf_logreg \
char_vdcnn \
...
export TOXIC_PARAMS=best_configs/xgboost_ensemble.yaml
python main.py train_evaluate_predict_cv_pipeline -p xgboost_ensemble -m second
